...
> Design notes for **transcript-editor-actions** — a runnable typescript example that Turn edtech audio transcript text into concise publishing actions with TypeScript.
...
- **Feature code** — the actual task: transcript-editor.
